...
OXE_DATASET_CONFIGS = {
    ...
    ### Fractal datasets (my modified versions)
    "fractal_euler": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
    ...
    ### taco_play datasets (my modified versions)
        "taco_play_libero": {
        "image_obs_keys": {
            "primary": "rgb_static",
            "secondary": None,
    ...
    ### LIBERO datasets (OpenVLA modified versions)
    "libero_spatial": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["EEF_state", None, "gripper_state"],
        "state_encoding": ProprioEncoding.POS_EULER, # in reality it seems to be axis-angle [ax, ay, az]
        "action_encoding": ActionEncoding.EEF_POS,
    },
    "libero_object": {
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": "wrist_image"},
