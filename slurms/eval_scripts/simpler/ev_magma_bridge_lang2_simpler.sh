...
#SBATCH --job-name=ev_magma_lang2_bridge_simpler
...
CONFIG_NAMES=("magma_bridge_ev_lang2.yaml")
...
steps = cfg["eval_cfg"].get("pretrained_model_gradient_step_cnt", None)
if steps is None:
    # If the key doesn't exist, return a default value or an empty list
    steps = [15130]
            ...
            for STEP in "${CHUNK[@]}"; do
                ...
                singularity exec --nv \
                    ...
                    /bin/bash -c "source ./set_path.sh; \
                        ...
                        source ./src/experiments/policies/magma_policy_server/.venv/bin/activate; \
